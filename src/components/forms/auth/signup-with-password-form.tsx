    ...
    startTransition(async () => {
      try {
        ...
        switch (message) {
          case "exists":
            toast({
              title: "A user with the specified email address already exists",
              description: "If this is you, go to the sign in page",
              variant: "destructive",
            })
            form.reset()
            break
          case "success":
            toast({
              ...
              description: "Check your email to finish registration",
            })
